 ...
 * and accumulates the generated text as the document body in an {@link AiGenerationResult}.
...
public class AiFieldGenerationSupport {
     ...
     *         when {@code fieldGenerations} is empty or contains only {@code null} entries
