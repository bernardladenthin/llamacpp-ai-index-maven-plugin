...
public class SummarizeFilesMojo extends AbstractAiIndexMojo {

    /** llama.cpp context window size; larger default accommodates full source files. */
    @Parameter(property = "aiIndex.llama.contextSize", defaultValue = "32768")
    private int llamaContextSize;

    /** CPU threads for llama.cpp inference during file summarization. */
